...
**Production-safe, research-friendly.** Defaults that won't surprise you in production, with escape hatches for experimentation.

## The Name

Pollux is the brightest star in the Gemini constellation.

The library's job is to clear away infrastructure complexity so Gemini's capabilities reach your code cleanly. You focus on the interesting parts—the questions you want to ask, the content you want to analyze. The plumbing fades into the background.

## Acknowledgments

- Google Summer of Code 2025
- Google DeepMind mentorship
